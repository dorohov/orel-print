		...
		<div class="row <?=$param["block_prefix"];?>row  is--wrap">
			<div class="cols <?=$param["block_prefix"];?>cols  <?=$param["block_mod"];?>  is--name">
				<div class="<?=$param["block_prefix"];?>item">
					<input type="text" class="<?=$param["block_prefix"];?>control form-control validate[required]  <?=$param["block_mod"];?>  {{form_color}}" id="<?=$param["block_id"];?>[fio]" name="<?=$param["block_id"];?>[fio]" placeholder="Ваше имя:">
				</div>	
			</div>
			<div class="cols <?=$param["block_prefix"];?>cols  <?=$param["block_mod"];?>  is--email">
				<div class="<?=$param["block_prefix"];?>item">
					<input type="email" class="<?=$param["block_prefix"];?>control form-control validate[required,custom[email]]  <?=$param["block_mod"];?>  {{form_color}}" id="<?=$param["block_id"];?>[email]" name="<?=$param["block_id"];?>[email]" placeholder="E-mail:">
				</div>	
			</div>
			<div class="cols <?=$param["block_prefix"];?>cols  <?=$param["block_mod"];?>  is--tel">
				<div class="<?=$param["block_prefix"];?>item">
					<input type="tel" class="<?=$param["block_prefix"];?>control form-control validate[required,custom[phone]]  <?=$param["block_mod"];?>" id="<?=$param["block_id"];?>[tel]" name="<?=$param["block_id"];?>[tel]" placeholder="Телефон:">
				</div>	
			</div>
