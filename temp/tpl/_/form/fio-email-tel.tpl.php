<form action="#" class="<?=$param["block_prefix"];?>block"  >
	...
	<div class="<?=$param["block_prefix"];?>inner"  >
		<div class="row <?=$param["block_prefix"];?>row  is--wrap">
			...
			<div class="cols <?=$param["block_prefix"];?>cols  is--tel">
				<div class="<?=$param["block_prefix"];?>item">
					<input type="tel" class="<?=$param["block_prefix"];?>control form-control validate[required,custom[phone]]" id="<?=$param["block_id"];?>[tel]" name="<?=$param["block_id"];?>[Телефон]" placeholder="Ваш номер телефона">
				</div>	
			</div>
