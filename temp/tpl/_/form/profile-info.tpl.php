	...
	<div class="<?=$param["block_form_prefix"];?>inner  <?=$param["block_form_mod"];?>"  >
		<div class="row <?=$param["block_form_prefix"];?>row  is--wrap">
			...
			<div class="cols <?=$param["block_form_prefix"];?>cols  <?=$param["block_form_mod"];?>  is--name">
				<div class="<?=$param["block_form_prefix"];?>item">
					<input type="text" class="<?=$param["block_form_prefix"];?>control form-control validate[required, custom[onlyLetterSp]]  <?=$param["block_form_color"];?>" id="<?=$param["block_form_id"];?>[name]" name="<?=$param["block_form_id"];?>[ФИО]" placeholder="ФИО:"  value="Сидоров Егорыавпр Ефремович">
				</div>	
			</div>
			<div class="cols <?=$param["block_form_prefix"];?>cols  <?=$param["block_form_mod"];?>  is--email">
				<div class="<?=$param["block_form_prefix"];?>item">
					<input type="email" class="<?=$param["block_form_prefix"];?>control form-control validate[required,custom[email]]  <?=$param["block_form_color"];?>  <?=$param["block_form_color"];?>" id="<?=$param["block_form_id"];?>[email]" name="<?=$param["block_form_id"];?>[E-mail]" placeholder="E-mail:" value="ya@mail.ru">
				</div>	
			</div>
			<div class="cols <?=$param["block_form_prefix"];?>cols  <?=$param["block_form_mod"];?>  is--tel">
				<div class="<?=$param["block_form_prefix"];?>item">
					<input type="tel" class="<?=$param["block_form_prefix"];?>control form-control validate[required,custom[phone]]  <?=$param["block_form_color"];?>  <?=$param["block_form_color"];?>" id="<?=$param["block_form_id"];?>[tel]" name="<?=$param["block_form_id"];?>[tel]" placeholder="Телефон:" value="+7 (920) 086-45-66">
				</div>	
			</div>
			<div class="cols <?=$param["block_form_prefix"];?>cols  <?=$param["block_form_mod"];?>  is--pass">
				<div class="<?=$param["block_form_prefix"];?>item">
					<input type="password" class="<?=$param["block_form_prefix"];?>control form-control <?=$param["block_form_color"];?>  <?=$param["block_form_color"];?>" id="<?=$param["block_form_id"];?>[pass]" name="<?=$param["block_form_id"];?>[pass]" placeholder="Новый пароль:">
				</div>	
			</div>
