...
<div class="content-block <?=$block_prefix;?>content-block  is--hidden" role="main">	
	...
	<div class="container content-block__container <?=$block_prefix;?>container  bg-header__container">	
		<div class="print-panel-category__block">
			<div class="print-panel-category__row row  is--gutter  is--wrap">
				<?
				...
				?>
				<div class="print-panel-category__cols cols  is--cols-4">
					<div class="print-card__item">
						<a href="<?=$link;?>" class="print-card__preview block-hover__block">	
						...
						<h3 class="print-card__heading"><a href="<?=$link;?>"><?=$title;?></a></h3>	
					</div>
				</div>
				<?
				}
